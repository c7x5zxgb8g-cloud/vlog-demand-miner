...
- 配合 [skills/cheat-score-blind/WORKFLOW.md](../skills/cheat-score-blind/WORKFLOW.md) 的 `blocked_rubric_memo` refusal_code + cheat-bump Phase 5 leak guard 自检
...
- 配合 [skills/cheat-score-blind](../skills/cheat-score-blind/WORKFLOW.md) 的 channel B 隔离协议——把 contamination 跟踪从"靠 git history"升级为"靠 state 字段"
...
| 字段 | 类型 | 写入者 | 读取者 | 说明 |
|---|---|---|---|---|
| `schema_version` | string | cheat-init / cheat-migrate | 所有 skill | "1.1"。schema 升级时 bump；老用户由 [/cheat-migrate](../skills/cheat-migrate/WORKFLOW.md) 升级。详见 [migration-protocol.md](migration-protocol.md) |
...
| schema_version 不识别 | 提示版本号 + 建议跑 [/cheat-migrate](../skills/cheat-migrate/WORKFLOW.md)。SessionStart hook 会自动检测并提示 |
